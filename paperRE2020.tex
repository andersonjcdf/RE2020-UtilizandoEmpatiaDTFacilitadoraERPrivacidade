...
%Segundo \cite{DBLP:conf/interact/WolfelM13}  existem vários exemplos de method cards, focados no design participativo e no desenvolvimento da empatia. Assim, esses methods poderiam ser considerados ferramentas de empatia. Esses method cards envolvem designers e usuários no processo. Alguns method cards são projetados para uma melhor comunicação entre usuários e designers, como por exemplo Questionable Concept Cards, IDEO method cards entre outros.
